# BERT/Transformer + (Similarity: Fuzzy)

Bu klasör, `algorithms/bert-fuzzy/turkish_address_preprocessor.py` dosyasındaki **Python** çözümünün açıklamasını içerir.
...
```bash
python algorithms/bert-fuzzy/turkish_address_preprocessor.py
```
