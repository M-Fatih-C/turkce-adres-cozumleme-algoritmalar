# BERT/Transformer + TF-IDF + FAISS + LightGBM + (Similarity: Cosine+Fuzzy+Levenshtein)

Bu klasör, `notebooks/bert-faiss-lgbm-cosine-v3/Untitled7.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
- **Model(ler):** LightGBM
- **Benzerlik Ölçüleri:** Cosine, Fuzzy, Levenshtein
...
```bash
python notebooks/bert-faiss-lgbm-cosine-v3/Untitled7.ipynb
```
