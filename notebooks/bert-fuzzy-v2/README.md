...
Bu klasör, `notebooks/bert-fuzzy-v2/Untitled14.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/bert-fuzzy-v2/Untitled14.ipynb
```
