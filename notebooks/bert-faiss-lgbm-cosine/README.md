...
Bu klasör, `notebooks/bert-faiss-lgbm-cosine/Untitled12.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/bert-faiss-lgbm-cosine/Untitled12.ipynb
```
