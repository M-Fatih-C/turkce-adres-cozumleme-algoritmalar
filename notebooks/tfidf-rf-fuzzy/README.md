...
Bu klasör, `notebooks/tfidf-rf-fuzzy/Untitled4.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/tfidf-rf-fuzzy/Untitled4.ipynb
```
