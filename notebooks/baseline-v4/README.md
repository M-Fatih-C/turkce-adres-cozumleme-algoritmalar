...
Bu klasör, `notebooks/baseline-v4/Adres çöümleme.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/baseline-v4/Adres çöümleme.ipynb
```
