# BERT/Transformer + TF-IDF + FAISS + LightGBM + (Similarity: Cosine)

Bu klasör, `notebooks/bert-faiss-lgbm-cosine-v2/Untitled13.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/bert-faiss-lgbm-cosine-v2/Untitled13.ipynb
```
