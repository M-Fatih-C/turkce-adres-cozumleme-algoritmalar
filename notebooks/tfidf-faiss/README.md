...
Bu klasör, `notebooks/tfidf-faiss/Untitled10.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/tfidf-faiss/Untitled10.ipynb
```
