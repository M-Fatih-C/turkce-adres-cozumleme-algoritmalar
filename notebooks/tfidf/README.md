...
Bu klasör, `notebooks/tfidf/Turkce_TF_IDF_LSTM_Notebook.ipynb` dosyasındaki **Jupyter Notebook** çözümünün açıklamasını içerir.
...
```bash
python notebooks/tfidf/Turkce_TF_IDF_LSTM_Notebook.ipynb
```
